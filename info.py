...
PICS = (environ.get('PICS', 'https://telegra.ph/file/b446a3e8b7d04efffdba0.jpg')).split()
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001807888140').split()]
