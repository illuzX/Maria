...
if movie_ == "close_spellcheck":
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('Movie Not Found In DataBase Or This Is Not The Name Of Movie Please Check Google Or not Released in OTT')
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        logger.exception(e)
        k = await msg.reply("sorry i can't find  find anything ")
    ...
    if not movies:
        ...
        k = await msg.reply_photo(
            photo=info.PICS, 
            caption=(f" here is you're(mv_rqst)")
