...
async def index_files_to_db(lst_msg_id, chat, msg, uzx):
    ...
    async with lock:
        try:
            ...
            temp.CANCEL = False
            async for message in uzx.get_messages(chat, lst_msg_id, temp.CURRENT):
                if temp.CANCEL:
                ...
                if message.empty:
                    ...
                    no_media += 1
                    continue
                elif message.media not in [enums.MessageMediaType.DOCUMENT, enums.MessageMediaType.AUDIO, enums.MessageMediaType.VIDEO]:
                    unsupported += 1
                    continue
